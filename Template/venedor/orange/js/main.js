...
=========================================== */
	...
	$('.item').each(function() {
			...
			if (itemWidth < 240) {
				itemText.fadeOut(50, function() {
					$(this).closest('.item-add-btn').addClass('icon-cart');
				});
			} else {
				itemText.fadeIn(50, function() {
					$(this).closest('.item-add-btn').removeClass('icon-cart');
				});
			}
		});
	}

	$(window).on('load resize orientationchange', itemCart);
...
var style2 = '#responsive-nav-button:hover #responsive-nav-button-icon,#responsive-nav-button.active  #responsive-nav-button-icon, .tab-style-1 li a:hover,.tab-style-1 li.active a, .new-circle, .item-add-btn:hover, .item-add-btn:focus, .item-add-btn:active, .item-add-btn.active,.banner-slider .flex-control-paging li a.flex-active, #breadcrumb-container, .input-desc-box .icon-box,.portfolio-item > figure > figcaption > .zoom-button, .portfolio-item > figure > figcaption > .link-button,.category-image-slider-container .new-rect, .select-dropdown:hover .dropdown-toggle, .select-dropdown .dropdown-menu > li > a:hover, .noUi-connect, .noUi-handle, .pagination > li > a:hover,.pagination > li > span:hover, .pagination > li > a:focus,.pagination > li > span:focus,.icon-button:hover, .custom-quantity-input .quantity-btn:hover, .close-button:hover, #scroll-top,.btn-custom,.btn-custom-2:hover,.btn-custom-2:focus,.btn-custom-2:active,.btn-custom-2.active,.open .dropdown-toggle.btn-custom-2,.btn-custom-3:hover, .btn-custom-3:focus, .btn-custom-3:active,.btn-custom-3.active,.open .dropdown-toggle.btn-custom-3,#option-panel .colorbox-list li .first-color span, .progress-bar-custom, .small-bottom-border,.sequence-pagination li.current,.bx-wrapper .bx-controls-direction a:hover { background-color : #'+hex+';}';

style2 += '.tab-style-1 li a:hover, .tab-style-1 li.active a, #main-nav-container #main-nav ul li .mega-menu,.portfolio-item > figure > figcaption > .zoom-button, .portfolio-item > figure > figcaption > .link-button, .select-dropdown:hover .dropdown-toggle, .pagination > li > a:hover,.pagination > li > span:hover, .pagination > li > a:focus, .pagination > li > span:focus,.sidebar .widget .panel a:hover .icon-box, .icon-button:hover, .custom-quantity-input .quantity-btn:hover,.close-button:hover, #scroll-top, .item-add-btn:hover, .item-add-btn:focus, .btn-custom-2:hover,.btn-custom-2:focus, .btn-custom-3:hover,.btn-custom-3:focus,.bx-wrapper .bx-controls-direction a:hover{ border-color : #'+hex+';}';
...
style += '#main-nav-container #main-nav #responsive-nav ul, #quick-access .dropdown-cart .dropdown-cart-menu { border-top-color : #'+hex+';}';
		...
		$('.color-box.third-color').colpick({
			...
			color: '555555',
			onSubmit:function(hsb,hex,rgb,el) {
var style = '.discount-circle, .category-image-slider-container .discount-rect,#option-panel .colorbox-list li .third-color span { background-color : #'+hex+';}';
		...
		$('.color-box.fourth-color').colpick({
			...
			color: 'e82c0c',
			onSubmit:function(hsb,hex,rgb,el) {
var style = '.dropdown-cart  .dropdown-cart-product-list  .dropdown-cart-details .item-price, .item-price-container .item-price  { color: #'+hex+';}';
style += '#option-panel .colorbox-list li .fourth-color span, #option-panel-title, .contact-details-list .contact-details-icon, .contact-details-list .contact-details-icon { background-color : #'+hex+';}';
