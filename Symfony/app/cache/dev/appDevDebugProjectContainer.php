...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'troiswa', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/TroisWA/BackBundle/Entity'))), 'TroisWA\\BackBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('TroisWABackBundle' => 'TroisWA\\BackBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_988631abe2ccbb9e69ffe72b00ab9184161ac51df3b90c7a05e743531be5fea0');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('RAJOUTER');
        $a->setPassword('RAJOUTER');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig', 2 => 'TroisWABackBundle:Form:fields.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig', 2 => 'TroisWABackBundle:Form:fields.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[2].'/Resources/TroisWABackBundle/views'), 'TroisWABack');
        $instance->addPath(($this->targetDirs[3].'/src/TroisWA/BackBundle/Resources/views'), 'TroisWABack');
        $instance->addPath(($this->targetDirs[2].'/Resources/KnpPaginatorBundle/views'), 'KnpPaginator');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56277273b9f3a9.56539386')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TroisWABackBundle' => 'TroisWA\\BackBundle\\TroisWABackBundle',
            ...
            'client_id_instagram' => '13418a30fd0c4a44addd8c711ae9e949',
            'client_secret_instagram' => 'f7ad47b90c264cd98c789dad4a7e4d43',
            'callback_instagram' => 'https://bob.com',
            'token_instagram' => 'a3820c0fb437452ba5b33ac4e56c0411',
            'id_instagram' => 2244682721,
            'locale' => 'en',
            ...
            'twig.form.resources' => array(
                ...
                2 => 'TroisWABackBundle:Form:fields.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'RAJOUTER',
            'swiftmailer.mailer.default.transport.smtp.password' => 'RAJOUTER',
